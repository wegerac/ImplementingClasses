...
class Point(object):
    ...
    def __init__(self, x, y):
        ...
        self.origional_x = self.x
        self.origional_y = self.y
    ...
    def move_to(self,x,y):
        ...
        self.x = x
        self.y = y
        self.num_times_moved = self.num_times_moved + 1
        self.total_distance = self.total_distance + Point.get_distance_from(Point(firstx,firsty),Point(self.x,self.y))
        return self
    ...
    def get_distance_from_start(self):
        distance = Point.get_distance_from(Point(self.x,self.y),Point(self.origional_x,self.origional_y))
        return distance
